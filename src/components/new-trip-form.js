...
export class NewTripForm extends React.Component {
    ...
    render() {
      console.log('this.props.startDateTemp: ', this.props.startDateTemp);
      ...
      return (
        <div className="grid-new-trip-content">
          <form id="form__new-trip" onSubmit={this.props.handleSubmit(values => this.createTripModal(values))}>
            ...
            <Field type="text" placeholder="End Date" name="endDate" startDateProp={this.props.startDateTemp} component={DatePicker} change={change} required />
