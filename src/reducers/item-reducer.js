// import {CREATE_NEW_ITEM_SUCCESS, UPDATE_ITEM_SUCCESS, DELETE_ITEM_SUCCESS, MY_LIST_FILTER} from '../actions/index';
...
//     const trip = state.trips.find(trip => tripId === trip._id.toString());

//     return Object.assign({}, state, {currentTrip: {items: [...state.currentTrip.items, {
